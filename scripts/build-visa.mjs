...
const VISA_UNBLOCK = [
  ...
  'Ndude Wiseman Mawethu',
  'Mpembe Phumlani Justice Sbongile',
  'Mpembe Ntombifuthi Eugenia Maureen',
  'Lentsa-Ndude Morakapele Mable',
  'Mokoena Motlakapula Joyce',
  'Lekhuleni Thabo Tryphina',
  'Somdaka Sindiswa Rita',
  'Phofedi Moitsi Josephinah',
  'Mhlongo Nomafa Nonhlanhla',
  'Mashigo Monica',
  'Ntsibande Mandlenkosi Emanuel',
  'Nkomo Sakhile Blessing',
