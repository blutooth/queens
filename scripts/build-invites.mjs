...
const AUD_SALUTATION = { queens: 'Your Majesty', kings: 'Your Majesty', rulers: 'Your Majesty', morocco: 'Your Excellencies', queenmother: 'Queen Mother', princes: 'Your Highness', politicians: 'Your Excellency', guests: '', princesses: 'Your Highness', excellency: 'Your Excellency' };
...
function waAccept(name, audience) {
  const openers = {
    ...
    rulers: `Your Majesty, this is ${name} 👑`,
    morocco: `Your Majesty, this is ${name} 👑`,
    queenmother: `Queen Mother, this is ${name} 👑`,
    princes: `Your Highness, this is ${name} 👑`,
...
<body>
  <div class="wrap">
    ...
    <div class="tabs">
      ...
      <button class="tab" data-tab="diplomats">🏛️ Diplomats</button>
    ...
    <div class="card">
      ...
      <div class="two">
        ...
        <div class="field"><label>Audience (sets letter &amp; salutation)</label><select id="f-audience">
          ...
          <option value="rulers">Traditional Ruler (Nigeria)</option>
          <option value="queenmother">Queen Mother</option>
          <option value="princesses">Princess</option>
          <option value="princes">Prince</option>
    ...
    <div class="card">
      ...
      <div class="toolbar">
        ...
        <select id="filter-aud">
          ...
          <option value="rulers">Traditional Rulers (Nigeria)</option>
          <option value="queenmother">Queen Mothers</option>
    ...
    <div class="panel" id="tab-diplomats" hidden>
    <div class="card">
      <h2>Diplomatic missions</h2>
      <p class="hint" style="margin-top:0;">Heads of mission &amp; excellencies. Use <strong>✉ Email</strong> to open a pre-filled message carrying their personal invitation link — just add the mission's email address in the To field before sending.</p>
      <div id="dip-list"></div>
    </div>
    </div>
  ...
  function inviteUrl(name, audience, noLetter) {
    var SHORT = { queens: 'q', kings: 'k', rulers: 'tr', morocco: 'mo', queenmother: 'qm', princes: 'pi', princesses: 'pr', politicians: 'po', guests: 'g', excellency: 'ex' };
  ...
  var SAL_DEFAULT = { queens: 'Your Majesty', kings: 'Your Majesty', rulers: 'Your Majesty', morocco: 'Your Excellencies', queenmother: 'Queen Mother', princes: 'Your Highness', politicians: 'Your Excellency', guests: '', princesses: 'Your Highness', excellency: 'Your Excellency' };
  ...
  var NOTES = {
    ...
    rulers: 'It would be a profound honour to welcome Your Majesty among the sovereigns gathered in England this August.',
    ...
    queenmother: 'It would be a profound honour to welcome you, Queen Mother, among the royal matriarchs gathered in England this August.',
    princes: 'It would be a profound honour to welcome you among the royal princes gathered in England this August.',
  ...
  function isDiplomat(it) { return (it.audience || '') === 'excellency'; }
  function gmailCompose(it) {
    var url = personalUrl(it);
    var su = encodeURIComponent('Invitation — African Queens Summit · 14–31 August 2026');
    var body = encodeURIComponent(
      'Your Excellency,\\n\\n' +
      'It would be a distinct honour to receive you at the African Queens Summit in England this August. ' +
  ...
  // --- diplomats list (excellency audience) ---
  var dipList = document.getElementById('dip-list');
  if (dipList) {
    var dips = INVITES.filter(isDiplomat);
    if (!dips.length) { dipList.innerHTML = '<p class="empty">No diplomatic invitations yet — set an invitee\\'s audience to “Head of State / Excellency”.</p>'; }
    else { dips.forEach(function (it) { dipList.appendChild(renderRow(it)); }); }
  }
...
<body>
  ...
  <div class="sheet"><div class="pad">
    ...
    <div class="foot">
      ...
      <div class="meta" style="font-family:'Marcellus',serif;letter-spacing:.06em;color:var(--emerald-deep);"><a href="https://africanqueenssummit.com" style="color:var(--emerald-deep);">www.africanqueenssummit.com</a></div>
...
<body>
  ...
  <div class="sheet"><div class="pad">
    ...
    <p class="inv-re">Re: African Queens Summit 2026 &middot; 14&ndash;31 August 2026</p>
...
<body>
  ...
  (function () {
    ...
    var TYPE_MAP = { q: 'queens', k: 'kings', tr: 'rulers', mo: 'morocco', qm: 'queenmother', pi: 'princes', pr: 'princesses', po: 'politicians', g: 'guests', ex: 'excellency', lm: 'lordmayor' };
    ...
    var SAL = { queens: 'Your Majesty', kings: 'Your Majesty', rulers: 'Your Majesty', morocco: 'Your Excellencies', queenmother: 'Queen Mother', princes: 'Your Highness', politicians: 'Your Excellency', guests: '', princesses: 'Your Highness', excellency: 'Your Excellency', lordmayor: 'Right Worshipful Lord Mayor' };
    var LETTERS = ${lettersJson};
    ...
    var openers = { queens: 'Your Majesty, this is ' + name + ' \\uD83D\\uDC51', kings: 'Your Majesty, this is ' + name + ' \\uD83D\\uDC51', rulers: 'Your Majesty, this is ' + name + ' \\uD83D\\uDC51', morocco: 'Your Majesty, this is ' + name + ' \\uD83D\\uDC51', queenmother: 'Queen Mother, this is ' + name + ' \\uD83D\\uDC51', princes: 'Your Highness, this is ' + name + ' \\uD83D\\uDC51', politicians: 'Your Excellency, this is ' + name, guests: 'Hello, this is ' + name, princesses: 'Your Highness, this is ' + name + ' \\uD83D\\uDC51', excellency: 'Your Excellency, this is ' + name, lordmayor: 'Right Worshipful Lord Mayor, this is ' + name };
...
const rawLetters = {};
for (const a of ['queens', 'kings', 'rulers', 'morocco', 'queenmother', 'princes', 'politicians', 'guests', 'princesses', 'excellency', 'lordmayor']) {
...
for (const a of ['queens', 'kings', 'rulers', 'morocco', 'queenmother', 'princes', 'politicians', 'guests', 'princesses', 'excellency', 'lordmayor']) lettersHtmlMap[a] = getLetter(a);
